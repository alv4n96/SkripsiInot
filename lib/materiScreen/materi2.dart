          ...
          child: CustomScrollView(
            slivers: <Widget>[
              ...
              SliverList(
                ...
                PictBuilder(
                    image: "src/img/materi/2_1.jpg",
                    label: '''Peta negara-negara dalam PD II
Sumber: idntimes
'''),
                BuildText(theText: '''
1.	Blok sentral yaitu Jerman, Italia, Jepang, Austria, Rumania, dan Finlandia.
2.	Blok sekutu yaitu Inggris, Prancis, Rusia, RRC, Amerika Serikat, Austria, Uni Soviet dan Polandia. 
'''),
                BuildText(theText: '''
...
'''),
                ...
                BuildText(
                    theText: '''Kronologi Perang Dunia II di Front Pasifik 

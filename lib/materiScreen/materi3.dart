          ...
          child: CustomScrollView(
            slivers: <Widget>[
              ...
              SliverList(
                ...
                PictBuilder(
                    image: "src/img/materi/3_1.jpg",
                    label: '''Gambar bendera Amerika Serikat dan Uni Soviet'''),
                BuildText(
                    theText:
                ...
                BuildText(theText: '''a.	Bidang Politik
...
'''),
                BuildText(theText: '''b.	Bidang Ekonomi
...
'''),
                BuildText(theText: '''c.	Bidang Sosial
...
'''),
                ...
                PictBuilder(
                    image: "src/img/materi/3_2.png",
                    label: '''Korban Jiwa Perang Dunia II
(Sumber: P2k Um Surabaya)
''')
